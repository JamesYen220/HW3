        ...
        render: text =>
            this.state.searchedColumn === dataIndex ? (
                <Highlighter
                    ...
                    autoEscape
                    textToHighlight={text.toString()}  //show word highlighted
                />
            ) : (
                text
            ),
    ...
    render() {
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) =>
                    // Popover = when you hover over the field text shows up
                    <Popover content={
                        <div>
                            <p>-1: ban</p>
                            <p> 0: admin</p>
